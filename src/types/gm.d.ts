//https://www.npmjs.com/package/@types/greasemonkey/v/3.0.3?activeTab=code
...
declare module "$" {
	...
	declare function GM_deleteValues(name: string[]): void;
	/**
	...
	declare function GM_getValues(name: string[], defaultValue?: any): any[];
	declare function GM_getValues(name: string[], defaultValue?: string): string[];
	declare function GM_getValues(name: string[], defaultValue?: number): number[];
	declare function GM_getValues(name: string[], defaultValue?: boolean): boolean[];
