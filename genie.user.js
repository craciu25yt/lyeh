...
`;
	...
	var Genie = class {
		...
		async getAccentCache(songUrl, imgUrl) {
			...
			if (await _GM_getValue(cacheKey, null)) return cache;
			return new Promise((resolve, reject) => {
				privilegedFetch({
					method: "GET",
					url: imgUrl,
