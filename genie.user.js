		...
		init() {
			...
			for (const category of settingsSchema) for (const setting of category.items) {
				...
				if (setting.id == "spotify") {
					if (settingValue) document.documentElement.style.setProperty(`--settings-spotify`, "none");
					else document.documentElement.style.setProperty(`--settings-spotify`, "flex");
					continue;
				}
