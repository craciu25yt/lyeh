...
(function() {
	...
	_css(" .heatmap-grid[data-v-f39e3dd0]{grid-template-rows:repeat(3,1fr);grid-template-columns:repeat(10,1fr);grid-auto-flow:column;gap:5px;display:grid;position:relative}.heatmap-square[data-v-f39e3dd0]{aspect-ratio:1;background-color:#0000004d;border:1px solid #ffffff26;border-radius:5px;align-self:end;position:relative}.heatmap-square[data-v-f39e3dd0]:after{content:attr(data-day);opacity:0;visibility:hidden;color:#fff;white-space:nowrap;pointer-events:none;z-index:10;background-color:#1a1a1e;border:1px solid #ffffff26;border-radius:10px;padding:5px 10px;transition:opacity .15s,visibility .15s;display:block;position:absolute;bottom:120%;left:50%;transform:translate(-50%);box-shadow:0 4px 12px #00000080}.heatmap-square[data-v-f39e3dd0]:hover:after{opacity:1;visibility:visible}.spinner[data-v-f39e3dd0]{z-index:10;border:6px solid #ffffff4d;border-top-color:#fa64a0;border-radius:50%;width:50px;height:50px;animation:1s linear infinite spin-f39e3dd0;position:absolute;top:50%;left:50%}@keyframes spin-f39e3dd0{0%{transform:translate(-50%,-50%)rotate(0)}to{transform:translate(-50%,-50%)rotate(360deg)}}[data-v-9a0dfe8c]::selection{color:#fff;background-color:#fa64a0b3}.overlay[data-v-9a0dfe8c]{z-index:99999;color:#f1f2f6;background:#0003;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.overlay[data-v-9a0dfe8c]:before{content:\"\";z-index:-1;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px);will-change:backdrop-filter;position:absolute;inset:0}.box[data-v-9a0dfe8c]{-webkit-backdrop-filter:blur(15px);backdrop-filter:blur(15px);background:#0006;border:1px solid #ffffff26;border-radius:24px;min-width:320px;padding:48px 64px;position:relative;box-shadow:0 8px 64px #00000080,inset 0 1px #ffffff1a}.close[data-v-9a0dfe8c]{color:#ffffff80;cursor:pointer;background:0 0;border:none;padding:0;font-size:28px;line-height:1;position:absolute;top:12px;right:16px}.close[data-v-9a0dfe8c]:hover{color:#fff}.title[data-v-9a0dfe8c]{text-align:center;margin:0 0 16px;font-size:28px;font-weight:700}.error-box[data-v-9a0dfe8c]{color:#fff;white-space:pre;background-color:#00000080;border:10px;border-radius:10px;padding:15px}.lyeh-footer[data-v-9a0dfe8c]{color:#c2c2c2;text-shadow:1px 1px #000;margin-top:10px}a[data-v-9a0dfe8c]{color:#fff!important}.overlay[data-v-ffa105c2]{z-index:99999;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px);background:#000000a6;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.box[data-v-ffa105c2]{-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);text-align:center;background:#ffffff14;border:1px solid #ffffff26;border-radius:24px;min-width:320px;padding:48px 64px;position:relative;box-shadow:0 8px 64px #00000080,inset 0 1px #ffffff1a}.close[data-v-ffa105c2]{color:#ffffff80;cursor:pointer;background:0 0;border:none;padding:0;font-size:28px;line-height:1;position:absolute;top:12px;right:16px}.close[data-v-ffa105c2]:hover{color:#fff}.title[data-v-ffa105c2]{color:#fff;letter-spacing:-.02em;margin:0 0 16px;font-size:28px;font-weight:700}.version[data-v-ffa105c2]{color:#fffc;justify-content:center;align-items:center;gap:12px;margin:0;font-size:18px;display:flex}.old[data-v-ffa105c2]{opacity:.5;text-decoration:line-through}.arrow[data-v-ffa105c2]{opacity:.6;font-size:22px}.new[data-v-ffa105c2]{color:#fff;font-weight:600}.changelog[data-v-ffa105c2]{text-align:left;border-top:1px solid #ffffff1a;max-height:300px;margin-top:24px;padding-top:16px;overflow-y:auto}.entry[data-v-ffa105c2]{margin-bottom:16px}.entry[data-v-ffa105c2]:last-child{margin-bottom:0}.entry-title[data-v-ffa105c2]{color:#ffffffe6;margin:0 0 8px;font-size:16px;font-weight:700}.entry-items[data-v-ffa105c2]{color:#ffffffa6;margin:0;padding-left:20px;font-size:14px;line-height:1.6;list-style:outside}.entry-items li[data-v-ffa105c2]{margin-bottom:2px}[data-v-052c0591]::selection{color:#fff;background-color:#fa64a0b3}body[data-v-052c0591]{height:100%;margin:0;overflow:hidden}.overlay[data-v-052c0591]{z-index:99999;color:#f1f2f6;background:#0003;justify-content:center;align-items:center;transition:display 1s;display:flex;position:fixed;inset:0}.overlay[data-v-052c0591]:before{content:\"\";z-index:-1;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px);will-change:backdrop-filter;position:absolute;inset:0}.box[data-v-052c0591]{-webkit-backdrop-filter:blur(15px);backdrop-filter:blur(15px);background:#0006;border:1px solid #ffffff26;border-radius:10px;min-width:40vw;position:relative;box-shadow:0 8px 64px #00000080,inset 0 1px #ffffff1a}.bar[data-v-052c0591]{border-bottom:1px solid #ffffff26;flex-direction:row;justify-content:space-between;padding:16px 20px;display:flex}.close[data-v-052c0591]{color:#ffffff80;cursor:pointer;background:0 0;border:none;padding:0;font-size:28px;line-height:1}.close[data-v-052c0591]:hover{color:#fff}.title[data-v-052c0591]{text-align:center;font-size:20px;font-weight:700}.content[data-v-052c0591]{padding:20px}.category-title[data-v-052c0591]{font-size:18px;font-weight:700}.setting-label[data-v-052c0591]{font-size:16px}.setting-label[data-disabled][data-v-052c0591]{opacity:.4}.setting-row[data-v-052c0591]{border-radius:10px;justify-content:space-between;align-items:center;padding:10px 10px 10px 20px;transition:all .1s cubic-bezier(.4,0,.2,1);display:flex;position:relative}.setting-row[data-v-052c0591]:hover{background:#ffffff1a}.setting-row[data-disabled][data-v-052c0591]:after{content:attr(data-tooltip);opacity:0;visibility:hidden;color:#fff;background-color:#1a1a1e;border:1px solid #ffffff26;border-radius:10px;padding:5px 10px;transition:opacity .15s,visibility .15s;position:absolute;bottom:105%;right:0;box-shadow:0 4px 12px #00000080}.setting-row[data-disabled][data-v-052c0591]:hover:after{opacity:1;visibility:visible}.setting-info[data-v-052c0591]{flex-direction:column;display:flex}.setting-description[data-disabled][data-v-052c0591]{opacity:.5}.setting-description[data-v-052c0591]{color:#c2c2c2;font-size:14px}.checkbox[data-v-052c0591]{opacity:0;width:0;height:0}.setting-input-wrapper[data-disabled][data-v-052c0591]{opacity:.5}.switch[data-v-052c0591]{width:50px;height:26px;display:inline-block;position:relative}.button-slider[data-v-052c0591]{cursor:pointer;background-color:#555;border-radius:26px;transition:background-color .2s;position:absolute;inset:0}.button-slider[data-v-052c0591]:after{content:\"\";background-color:#fff;border-radius:50%;width:20px;height:20px;transition:transform .2s cubic-bezier(.4,0,.2,1);position:absolute;bottom:3px;left:3px}.switch input:checked+.button-slider[data-v-052c0591]{background-color:#fa64a0b3}.switch input:checked+.button-slider[data-v-052c0591]:after{transform:translate(24px)}.switch input:focus-visible+.button-slider[data-v-052c0591]{box-shadow:0 0 0 2px #000,0 0 0 4px #fa64a0b3}.slider-bottom[data-v-052c0591]{margin-top:10px}.slider-bottom[data-v-052c0591],.slider[data-v-052c0591]{appearance:none;width:var(--length);cursor:pointer;background-color:#0000;border-radius:16px;outline:none;height:15px;overflow:hidden}.slider-bottom[data-v-052c0591]::-webkit-slider-runnable-track{background:#0006;border-radius:16px;height:15px}.slider[data-v-052c0591]::-webkit-slider-runnable-track{background:#0006;border-radius:16px;height:15px}.slider-bottom[data-v-052c0591]::-moz-range-track{background:0 0;border-radius:16px;height:15px}.slider[data-v-052c0591]::-moz-range-track{background:0 0;border-radius:16px;height:15px}.slider-bottom[data-v-052c0591]::-webkit-slider-thumb{appearance:none;background-color:#fff;border:2px solid #fa64a0b3;border-radius:50%;width:15px;height:15px;box-shadow:-407px 0 0 400px #fa64a0b3}.slider[data-v-052c0591]::-webkit-slider-thumb{appearance:none;background-color:#fff;border:2px solid #fa64a0b3;border-radius:50%;width:15px;height:15px;box-shadow:-407px 0 0 400px #fa64a0b3}.slider-bottom[data-v-052c0591]::-moz-range-thumb{background-color:#fff;border:1px solid #fa64a0b3;border-radius:50%;width:15px;height:15px;box-shadow:-407px 0 0 400px #fa64a0b3}.slider[data-v-052c0591]::-moz-range-thumb{background-color:#fff;border:1px solid #fa64a0b3;border-radius:50%;width:15px;height:15px;box-shadow:-407px 0 0 400px #fa64a0b3}.slider-footer[data-v-052c0591]{justify-content:space-between;margin-top:-4px;padding-top:2px;font-size:14px;display:flex}.slider-value[data-v-052c0591],.slider-reset[data-v-052c0591]{color:#c2c2c2!important}.slider-reset[data-v-052c0591]:hover{color:#fff!important}.button[data-v-052c0591]{background:#ffffff1a;border:1px solid #ffffff26;border-radius:10px;padding:10px 20px;box-shadow:0 4px 12px #00000080}.button[data-v-052c0591]:hover{background:#fa64a066}.text-input[data-v-052c0591]{color:#fff;background:#0006;border:1px solid #ffffff26;border-radius:10px;width:200px;padding:8px 12px;font-size:14px}.text-input[data-v-052c0591]:focus{border-color:#fa64a0b3;outline:none}.yt-container[data-v-d5e3911a]{z-index:5;width:var(--settings-player-width);-webkit-backdrop-filter:blur(15px);backdrop-filter:blur(15px);background-color:#15101080;border:1px solid #ffffff26;border-radius:10px;align-items:center;height:7.5vh;padding:7px;display:flex;position:fixed;bottom:20px;left:50%;transform:translate(-50%)}.yt-player[data-v-d5e3911a]{flex-direction:row;align-items:center;gap:12px;width:100%;height:100%;display:flex}.cover-wrapper[data-v-d5e3911a]{height:100%;padding:1px}.player-cover[data-v-d5e3911a]{border-radius:5px;width:100%;height:100%}.logo-wrapper[data-v-d5e3911a]{height:40%;padding:1px 20px 1px 1px}.yt-metadata[data-v-d5e3911a]{flex-direction:column;flex:1;justify-content:center;min-width:0;max-width:100px;line-height:1.1;display:flex}.song-name[data-v-d5e3911a],.song-artists[data-v-d5e3911a]{white-space:nowrap;text-overflow:ellipsis;width:100%;font-size:15px;overflow:hidden}.song-artists[data-v-d5e3911a]{color:#ffffffb3;font-size:11px}.playback-button[data-v-d5e3911a]{cursor:pointer;width:40px;height:40px;padding:2px}.progress-container[data-v-d5e3911a]{flex-grow:1;align-items:center;gap:10px;margin-right:12px;display:flex}.time-text[data-v-d5e3911a]{color:#ffffffb3;white-space:nowrap;font-family:sans-serif;font-size:11px}.progress-slider[data-v-d5e3911a]{appearance:none;cursor:pointer;background:#fff3;border-radius:2px;outline:none;width:100%;height:3px;transition:background .1s}.progress-slider[data-v-d5e3911a]::-moz-range-thumb{background:#fff;border:none;border-radius:50%;width:12px;height:12px;transition:transform .1s}.progress-slider[data-v-d5e3911a]::-webkit-slider-thumb{appearance:none;background:#fff;border-radius:50%;width:12px;height:12px;transition:transform .1s;box-shadow:0 1px 3px #0006}.youtube-player-inner[data-v-d5e3911a]{visibility:hidden;width:0;height:0;position:absolute}\n/*$vite$:1*/ ");
	_css(":root{--lyeh-bg-primary:#292424;--lyeh-bg-shadow:#1a1616;--lyeh-bg-secondary:#362f2f;--lyeh-bg-thirdy:#2e2828;--lyeh-accent:#ed4597;--lyeh-text-main:#f1f2f6;--lyeh-text-muted:#a4b0be;--accent-muted:#fa64a080;--lyeh-current-song-accent:#000;--lyeh-current-song-accent-secondary:#000;--artist-banner-url:linear-gradient(180deg, #1e1e2e 0%, #313244 50%, #1e1e2e 100%);--current-accent:#ffff64;--settings-player-width:40vh;--settings-spotify:flex}body,div[class^=PageLayout__Container],main{transition:background-color 1s;background-color:var(--lyeh-bg-primary)!important;color:var(--lyeh-text-main)!important;fill:var(--lyeh-text-main)!important}path{fill:var(--lyeh-text-main)}object[class^=profile_achievements-badge-icon]{fill:red!important;background-color:red!important}div[class^=StickyNavLoggedIn__Container] path{fill:color-contrast(var(--current-accent))}div[class^=Lyrics__Container]{letter-spacing:-.01em!important;color:var(--lyeh-text-main)!important;font-size:1.15rem!important;line-height:1.7!important}div[class^=Lyrics__Container] a{transition:all .2s;-webkit-text-decoration-color:var(--lyeh-accent)!important;text-decoration-color:var(--lyeh-accent)!important}.rich_text_formatting a:hover{background-color:#fa64a080;border-radius:4px}span[class^=ReferentFragment]{background:var(--lyeh-bg-secondary);z-index:1;color:var(--lyeh-text-main)!important}.lyeh-linked-hover{color:var(--lyeh-text-main)!important;background:#fa64a04d!important}[class^=TextLabel],[class^=ContributorsCreditSong]{color:var(--lyeh-text-main)!important}a:not([class^=StickyNavSectionLink__StyledLink]){color:var(--lyeh-text-main)!important;-webkit-text-decoration:underline #ffffff80!important;text-decoration:underline #ffffff80!important}span{color:var(--lyeh-text-main)!important}div[class^=SongHeader-desktop__CoverArt] img{border-radius:10px}aside[class^=ContributorSidebar__Container]{box-shadow:5px 5px 5px var(--lyeh-bg-shadow);border-radius:15px;padding-right:14px;background-color:#16141496!important}div[class^=ContributorSidebarSection__Header],div[class^=ContributorSidebarMetadata]{color:var(--lyeh-text-main)}button[class^=Button__Container-sc]{border:1px solid var(--lyeh-text-main);color:var(--lyeh-text-main)!important}button[class^=Button__Container-sc]:hover{background-color:#fa64a080!important;transition:all .2s cubic-bezier(.4,0,.2,1)!important}a[class^=Button__Container-sc]{border:1px solid var(--lyeh-text-main);color:var(--lyeh-text-main)!important}a[class^=Button__Container-sc]:hover{background-color:#fa64a080!important;transition:all .2s cubic-bezier(.4,0,.2,1)!important}button[class^=ContributorActionTextbox]{border:1px solid var(--lyeh-text-main);color:var(--lyeh-text-main)!important}div[class^=ContributorSidebarSection__HeaderButtons] svg path:first-child{fill:var(--lyeh-text-main)!important}div[class^=ContributorSidebarSection__HeaderButtons] svg path:last-child{fill:var(--lyeh-bg-primary)!important}div[class^=PageGrid-desktop][class*=StickyToolbar__Container]{border-bottom:none;background-color:var(--lyeh-bg-primary)!important}button[class^=SmallButton__Container]{border-color:var(--lyeh-text-main);color:var(--lyeh-text-main)!important}button[class^=SmallButton__Container]:hover{background-color:#fa64a080!important;transition:all .2s cubic-bezier(.4,0,.2,1)!important}a[class^=SmallButton__Container]{border-color:var(--lyeh-text-main);color:var(--lyeh-text-main)!important}a[class^=SmallButton__Container]:hover{background-color:#fa64a080!important;transition:all .2s cubic-bezier(.4,0,.2,1)!important}svg[class^=LineItemActionIcon__Icon][data-action-name=recognized] path,svg[class^=LineItemActionIcon__Icon][data-action-name=accepted] path,svg[class^=LineItemActionIcon__Icon][data-action-name=hit_pageview_threshold] path,svg[class^=LineItemActionIcon__Icon][data-action-name=upvoted] path{fill:#4bbf38!important}div[class^=LineItemList__Container] path{fill:#9a9a9a!important}div[class^=LineItem__IqDifference]{color:#4bbf38!important}svg[class^=LineItemActionIcon__Icon][data-action-name=earned] path{fill:#c7ba18!important}span[class^=ContributorActionTextbox]{color:var(--lyeh-text-main)!important}div[class^=StickyNavScrollTopLink__Container] span{color:color-contrast(var(--current-accent))!important}div[class^=StickyNavSections-sc] a{border-radius:5px}[color=background\\.iqPoints]{color:#4bbf38!important}[color=background\\.negativeNumber]{color:#f03e26!important}div[class^=ContributorsCreditMarkedComplete__CompletedUsernameContainer]{color:var(--lyeh-text-main)!important}div[class^=TooltipShadow]{color:var(--lyeh-text-main);z-index:1;background-color:#0000;border-radius:15px;position:relative;overflow:hidden}div[class^=TooltipShadow]:before{content:\"\";filter:blur(2px)brightness(.5);z-index:-1;background-position:50%;background-size:cover;border:0;transition:all 1s;position:absolute;inset:0;transform:scale(1.1);background-image:var(--artist-banner-url)!important;border-radius:15px!important}div[class^=ArtistTooltip__Verified]{color:#000;text-align:center;background-color:#ffff64;margin-right:30%;font-size:.75rem;border-radius:15px!important}div[class^=TooltipShadow]:has([class^=ArtistTooltip__Verified]){box-shadow:1px 1px 20px #ffff6480!important}div[class^=TooltipShadow]:has([role=moderator]){box-shadow:1px 1px 20px #047ec680!important}div[class^=Placeholder__Container]{background-color:#fa64a0b3!important}span[class^=UserBadge__Iq]{border-radius:10px;padding:.125rem .225rem;color:#000!important;background-color:#ffff64cc!important}button{color:#fff!important}div[class^=UserBadge__Role-sc-]{align-items:center;padding:4px 0;transition:all .3s ease-in-out;display:inline-flex;overflow:hidden}span[class^=UserBadge__RoleLabel-sc-]{opacity:0;white-space:nowrap;max-width:0;margin-right:0;transition:max-width .3s ease-in-out,opacity .2s ease-in-out,margin .3s ease-in-out;display:inline-block}div[class^=UserBadge__Role-sc-]:hover span[class^=UserBadge__RoleLabel-sc-]{opacity:1;max-width:100px;margin-right:6px}span[class^=RoleIcon__Container-sc-]{flex-shrink:0;align-items:center;width:14px;height:14px;display:flex}span[class^=RoleIcon__Container-sc-] svg{width:100%;height:100%}div[class^=AlbumTracklist__Track]{color:var(--lyeh-text-main)}div[class^=PageGrid-desktop][class*=SongHeader-desktop__Container] :is(span,a,button,path){color:color-contrast(var(--current-accent))!important;fill:color-contrast(var(--current-accent))!important}div[class^=white_container]{background-color:#0000}span[class^=LineItemMessage__NoteBubble]{background-color:#fa64a0b3!important}input{caret-color:var(--lyeh-accent)}::selection{color:#fff;background-color:#fa64a0b3!important}div[class^=ScrollableTabs__TabNavContainer]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border-radius:15px 15px 0 0;background-color:#00000080!important}div[class^=ScrollableTabs__ContentArea]{background-color:#0000;position:relative}div[class^=ScrollableTabs__ContentArea]:before{content:\"\";z-index:-1;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);position:absolute;inset:0;background-color:#00000080!important}h3[class^=ScrollableTabsSection__Title],legend[class^=Field-shared__FieldLabel]{color:var(--lyeh-text-main)}div[class^=TagInputMultiComponents]{background-color:#0000}div[class^=css-][class*=multiValue]{background-color:#fa64a066;border-radius:10px}div[class^=ReactSelect-components]{color:var(--lyeh-text-main)}div[id^=react-select]{color:#fff;-webkit-backdrop-filter:blur(10px)!important;backdrop-filter:blur(10px)!important;background-color:#0000!important}div[class^=css-][class*=menu]{background-color:#fff3}div[class^=css-][class*=option]:hover{background-color:#fa64a066!important}div[class^=RepeatableInputPair__Row-sc]{border:thin solid var(--lyeh-text-main)}div[class^=css-hfv4dh-singleValue]{color:var(--lyeh-text-main)}div[class^=ScrollableTabsSection__HeaderActions] path:last-child{fill:#000}button[class^=IconButton-sc][class*=Modal-desktop__SaveIconButton-sc]{background-color:#56a932!important}button[class^=IconButton-sc][class*=Modal-desktop__SaveIconButton-sc] path{fill:#fff!important}label[class^=Modal-desktop__ButtonField] button[aria-label=Save]:hover{background-color:#6abd46!important}label[class^=Modal-desktop__ButtonField] button[aria-label=Cancel]:hover{background-color:#fa64a099!important}div[class^=LyricsHighlightTooltip__Content]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);color:var(--lyeh-text-main);background-color:#16141496;border:0;border-radius:10px;border:1px solid #fff3!important}div[class^=LyricsHighlightTooltip__Content]:hover{background-color:var(--accent-muted)!important}button[class^=LyricsHighlightTooltip__Container]:before{display:none}div[class^=LyricsHighlightTooltip__Content]:before:hover{background-color:var(--accent-muted)!important}span[class^=LyricsHighlightTooltip__IQ]{color:#40ff21!important}a[class^=LyricsHeader__TranslationLink]{background:0 0}a[class^=LyricsHeader__TranslationLink]:hover{background-color:var(--accent-muted)!important}div[class^=VotesModal__Container]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background-color:#29242466;border-radius:10px}ul[class^=StickyToolbarDropdown__DropdownItems]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border-radius:10px;color:#fff!important;background-color:#29242466!important;border:1px solid #ffffff26!important}li[class^=StickyToolbarDropdownItem__Container]:last-child{border-bottom-right-radius:9px;border-bottom-left-radius:9px}li[class^=StickyToolbarDropdownItem__Container]:first-child{border-top-left-radius:9px;border-top-right-radius:9px}li[class^=StickyToolbarDropdownItem__Container]:hover{background-color:#fa64a080}li[class^=StickyToolbarDropdownItem__Container]:before{clip-path:polygon(0 0,100% 0,100% 100%);background-color:#fff!important;border-color:#fff!important}div[class^=TagInput__Container] div[class^=css][class*=-control]{border-color:var(--lyeh-text-main)!important}div[class^=Toast__Container]{background-color:#0000!important}div[class^=Toast__Container] div[class^=Alert__Container][color=success\\.main]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid #ffffff26;border-radius:10px;background-color:#fa64a066!important}div[class^=Toast__Container] div[class^=Alert__Container][color=success\\.main] path{fill:var(--lyeh-text-main)}div[class^=Alert__Container][color=background\\.on]{background-color:#ff43434a;border:1px solid #ffffff26;border-radius:10px}.iq_notification{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid #ffffff26;border-radius:10px;box-shadow:none!important;background-color:#db598d7d!important}div[class^=TooltipContent-sc]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid #ffffff26;border-radius:10px;background-color:#0006!important;outline:none!important}");
	_css("body{scroll-behavior:smooth}body:has(div[class^=ReactModalPortal]>div){scroll-behavior:auto!important}div[class^=Modal-shared__ModalSharedContainer]{background-color:#0000}div[class^=ContributionsScholars__Container]{-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px);background-image:none;border-radius:10px 10px 0 0;background-color:#000000b3!important}div[class^=RecentActivity__Container]{-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px);background-color:#0000001a}div[class^=LineItem__ItemRow]{background-color:#16141496;border:0;border-radius:10px;margin-top:8px;border:1px solid #fff3!important}div[class^=LineItem__ItemRow]:hover{background-color:#161414;transition:all .2s cubic-bezier(.4,0,.2,1)}div[class^=Annotation__Container]{color:var(--lyeh-text-main)}div[class^=LineItemList__Container],div[class^=LineItemList__Container]>div{background:0 0!important}body[class^=act-embed\\ cont-searches]{padding:20px;background-color:#0000!important}mini-article-card a{border-radius:10px 0 0 10px;background-color:#141414!important}.mini_card{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);color:var(--lyeh-text-main);border-radius:10px;padding:10px;background-color:#16141496!important;border:1px solid #fff3!important}mini-song-card .mini_card{padding:10px;background-color:#16141496!important}.mini_card path{fill:var(--lyeh-text-main)!important}.mini_card:hover{background-color:#16141496!important}.mini_card-lyric_excerpt span{color:#d6d6d6!important;background-color:#fa64a080!important}div[class^=mini_card-thumbnail]{border-radius:10px}div[class^=mini_card-thumbnail] path:first-child{fill:#16141496!important}a[class^=full_width_button]{background-color:#0000!important}mini-video-card a{padding:10px!important}div[class^=thumbnail_grid]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);color:var(--lyeh-text-main);border:1px solid #fff3;border-radius:10px;background-color:#16141496!important}div[class^=thumbnail_grid-grid_element]{padding:5px}div[class^=thumbnail_grid-grid_element]:hover{background-color:#16141496!important}.vertical_album_card:hover{background-color:unset!important}li[class^=ContributorList__ListItem]{border-radius:10px;border-bottom:none!important}li[class^=ContributorList__ListItem]:not(:last-child){margin-bottom:3px!important}div[class^=Attribution__Author]{color:var(--lyeh-text-main)}div[class^=TagInput__DragPreview][class*=-multiValue]{-webkit-backdrop-filter:blur(5px);backdrop-filter:blur(5px);background-color:#fa64a066;border-radius:10px}button[class^=RepeatableInputPair__Remove]{border:none;background-color:#000000b3!important}div[class^=AnnotationEditProposals__Container]{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);background-color:#1f1a1a80;border:1px solid #ffffff26;border-radius:10px}div[class^=AnnotationEditProposals__Proposal]{border-color:#fff6!important}");
	...
	_css("div[class^=SectionTitle__Title-sc]{color:var(--lyeh-text-main)}div[class^=ExpandableListItem__Container]{border-color:var(--lyeh-text-main)}div[class^=ExpandableListItem__Title]{color:var(--lyeh-text-main);background-color:#0000}div[class^=AlbumCredits__Columns] div,div[class^=SongCredits__Columns] div{color:var(--lyeh-text-main)!important}a[class^=SongTags__Tag]{border-color:var(--lyeh-text-main)!important}div[class^=TracklistOffsetContainer]{color:#fff!important}");
	_css(".standalone_annotation{border:1px solid #fff9;border-radius:10px;padding:20px;background-color:#16141496!important}a[class^=referent--accent_font\\ referent--line_break]{background-color:#fa64a0b3!important}div[class^=profile_achievements-badge-name]{color:var(--lyeh-text-main)}div[class^=statistics_panel]{background-color:#0000}div[class^=statistics_panel] path{fill:var(--lyeh-text-main)}a[class^=profile_contribution]{border:1px solid #fff9;border-radius:10px;padding:20px;background-color:#16141496!important}.profile_contribution{border:1px solid #fff9;border-radius:10px;padding:20px;color:var(--lyeh-text-main)!important;background-color:#16141496!important}a[class^=referent]{background-color:#0000!important}div[class^=note_bubble]{background-color:var(--accent-muted)!important}div[class^=note_bubble]:before{border-bottom-color:var(--accent-muted)!important}profile-user-pane .white_container,.statistics_panel{border-radius:10px;background-color:#16141496!important}[ng-show=\"!$ctrl.show_artist_pane\"] [class*=column_layout-column_span--secondary]{width:40%}[ng-show=\"!$ctrl.show_artist_pane\"] [class*=column_layout-column_span--primary]{width:100%}.column_layout[ng-show=\"!$ctrl.show_artist_pane\"]{max-width:1200px;padding:0}.profile_header .column_layout{max-width:1480px;margin:none!important;width:none!important}.profile_identity-iq{border-radius:10px;color:#000!important;background-color:#ffff64e6!important;padding:5px 10px!important}span[class^=user_badge-iq]{border-radius:5px;color:#000!important;background-color:#ffff64e6!important;padding:0 5px!important}.header-action-label{display:none}.feed_dropdown{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);color:var(--lyeh-text-main)!important;background-color:#19242466!important;border-radius:10px!important;top:3rem!important}.inbox_line_item_detail{background-color:#0000}.gray_container{border-radius:10px;background-color:#0006!important}.tooltip{-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border-radius:10px;color:#fff!important;background-color:#29242466!important;border:1px solid #ffffff26!important}.lyeh-tag{background-color:#fa64a080;border-radius:4px;padding:1px 6px;font-weight:700;color:#ddd!important}.lyeh-injected-title{color:#9a9a9a!important}form[class^=global_search] input{background-color:var(--lyeh-bg-primary);color:#fff;text-align:center;border-radius:15px}form[class^=global_search] input::placeholder{color:#fff;font-size:90%}.referent_container--inverse{background-color:#0000!important}scrollable-data[repeat-with=leaderboard_row] div{border:none!important}");
	...
	var _hoisted_1$4 = { class: "heatmap-grid" };
	var _hoisted_2$4 = {
		key: 0,
		class: "spinner"
	};
	var _hoisted_3$4 = ["data-day"];
	var DAY = 1e3 * 60 * 60 * 24;
	var Heatmap_vue_vue_type_script_setup_true_lang_default = defineComponent({
		__name: "Heatmap",
		setup(__props) {
			console.vLog("Initializing heatmap");
			const loading = ref(true);
			console.vLog(_unsafeWindow.CURRENT_USER);
			const heatData = ref(Array.from({ length: 30 }, () => 0));
			const normalize = (d) => {
			...
			async function getHeat(userID) {
				let nextCursor = null;
				const heat = new Array();
				const contributions = [];
				const data = await (await fetch(`https://genius.com/api/users/${userID}/contributions?per_page=50&text_format=plain`)).json();
				...
				while (nextCursor && dataOldacy < 30) {
					...
					const reFetchData = await (await fetch(`https://genius.com/api/users/${userID}/contributions?per_page=50&text_format=plain&next_cursor=${nextCursor}`)).json();
			...
			function getDaysAgo(date) {
				const elmDate = normalize(new Date(date * 1e3));
				const delta = today.getTime() - elmDate.getTime();
				return Math.round(delta / DAY);
			}
			function getTooltip(daysAgo) {
				const date = new Date(today.getTime());
				date.setDate(date.getDate() - daysAgo);
				const [weekday, month, day, year] = dateFormatter.format(date).replace(/,/g, "").split(" ");
				return `${`${weekday}, ${day} ${month} ${year}`}: ${heatData.value[daysAgo] ?? 0} contributions`;
			}
			function colorHandler(contributions) {
				if (contributions <= 5) return `rgba(250, 100, 160, ${Math.min(.2 * contributions, 1)})`;
				return `color-mix(in srgb, rgb(250, 100, 160) 100%, rgb(128, 100, 250) ${Math.min((contributions - 5) / 5 * 100, 100)}%)`;
			}
			onMounted(async () => {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$4, [loading.value ? (openBlock(), createElementBlock("div", _hoisted_2$4)) : createCommentVNode("", true), (openBlock(), createElementBlock(Fragment, null, renderList(30, (n) => {
					return createBaseVNode("div", {
						class: "heatmap-square",
						key: n,
						style: normalizeStyle({ backgroundColor: heatData.value[30 - n] ? colorHandler(heatData.value[30 - n]) : "" }),
	...
	var Heatmap_default = _plugin_vue_export_helper_default(Heatmap_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-f39e3dd0"]]);
	_css("div[class^=apple_music_player-player] button{color:var(--lyeh-text-main)!important;border-color:var(--lyeh-text-main)!important;background-color:#0000!important;padding:0 10px!important}div:has(>#notification-item-count){background-color:#0000!important}#notification-item-count~button{color:var(--lyeh-text-main)!important;border:1px solid var(--lyeh-text-main)!important;background-color:#0006!important;border-radius:5px!important}#notification-filter-dropdown{background-color:#0006!important}#notification-filter-dropdown label{color:#fff!important}#activity-filter-dropdown{background-color:#0006!important}");
...
`;
	...
	var _hoisted_6$2 = { class: "entry-title" };
	var _hoisted_7$2 = { class: "entry-items" };
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return visible.value ? (openBlock(), createElementBlock("div", {
					...
					entries.value.length ? (openBlock(), createElementBlock("div", _hoisted_5$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(entries.value, (entry) => {
						return openBlock(), createElementBlock("div", {
							key: entry.title,
							class: "entry"
						}, [createBaseVNode("h3", _hoisted_6$2, toDisplayString(entry.title), 1), createBaseVNode("ul", _hoisted_7$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(entry.items, (item, i) => {
	...
	var _hoisted_23 = { class: "slider-value" };
	...
	var settings_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			const settingsState = reactive(settingsSchema.reduce((acc, cat) => {
				cat.items.forEach((item) => {
					acc[item.id] = _GM_getValue(`lyeh:settings:${item.id}`) ? JSON.parse(_GM_getValue(`lyeh:settings:${item.id}`)) : item.default;
					if (item.disabled) {
			...
			function clearCache() {
				...
				if (toDelete.length != 0) _GM_deleteValues(toDelete);
			...
			onMounted(() => {
				window.addEventListener("lyeh:settings", handler);
			});
			onUnmounted(() => {
				window.removeEventListener("lyeh:settings", handler);
			});
			return (_ctx, _cache) => {
				return visible.value ? (openBlock(), createElementBlock("div", {
					key: 0,
				...
				}, [createBaseVNode("title", null, "Close"), createBaseVNode("path", {
					...
					return openBlock(), createElementBlock("div", {
						...
						return openBlock(), createElementBlock("div", {
							...
							item.type == "slider_bottom" ? (openBlock(), createElementBlock("div", {
								...
								onInput: ($event) => saveSetting(item.id, settingsState[item.id], item.format),
								class: "slider-bottom",
								style: normalizeStyle({ "--length": item.length + "vh" }),
							...
							item.type == "text" ? withDirectives((openBlock(), createElementBlock("input", {
								key: 1,
								id: item.id,
								type: "text",
								"onUpdate:modelValue": ($event) => settingsState[item.id] = $event,
								onInput: ($event) => saveSetting(item.id, settingsState[item.id]),
								class: "text-input",
								disabled: item.disabled
							}, null, 40, _hoisted_16)), [[vModelText, settingsState[item.id]]]) : createCommentVNode("", true),
							item.type == "boolean" ? (openBlock(), createElementBlock("label", _hoisted_17, [withDirectives(createBaseVNode("input", {
								id: item.id,
								type: "checkbox",
								"onUpdate:modelValue": ($event) => settingsState[item.id] = $event,
								...
								class: "checkbox",
								disabled: item.disabled
							}, null, 40, _hoisted_18), [[vModelCheckbox, settingsState[item.id]]]), _cache[2] || (_cache[2] = createBaseVNode("span", { class: "button-slider" }, null, -1))])) : createCommentVNode("", true),
							item.type == "boolean_callback" ? (openBlock(), createElementBlock("label", _hoisted_19, [withDirectives(createBaseVNode("input", {
								id: item.id,
								type: "checkbox",
								"onUpdate:modelValue": ($event) => settingsState[item.id] = $event,
								...
								class: "checkbox",
								disabled: item.disabled
							}, null, 40, _hoisted_20), [[vModelCheckbox, settingsState[item.id]]]), _cache[3] || (_cache[3] = createBaseVNode("span", { class: "button-slider" }, null, -1))])) : createCommentVNode("", true),
							item.type == "slider" ? withDirectives((openBlock(), createElementBlock("input", {
								...
								max: item.max,
								step: item.step
							}, null, 44, _hoisted_21)), [[vModelText, settingsState[item.id]]]) : createCommentVNode("", true),
							item.type == "slider" ? (openBlock(), createElementBlock("div", _hoisted_22, [createBaseVNode("span", _hoisted_23, toDisplayString(item.format ? item.format.replace("$!", settingsState[item.id]) : settingsState[item.id]), 1), settingsState[item.id] != item.default ? (openBlock(), createElementBlock("button", {
								key: 0,
								class: "slider-reset",
								onClick: ($event) => {
									saveSetting(item.id, item.default, item.format);
								...
								disabled: item.disabled
							}, " reset ", 8, _hoisted_24)) : createCommentVNode("", true)])) : createCommentVNode("", true)
						], 8, _hoisted_14)], 8, _hoisted_5$1);
					}), 128))])]);
				}), 128))])])])) : createCommentVNode("", true);
			};
		}
	}), [["__scopeId", "data-v-052c0591"]]);
	var _hoisted_1 = {
		key: 0,
		class: "yt-container"
	};
	var _hoisted_2 = { class: "yt-player" };
	var _hoisted_3 = { class: "cover-wrapper" };
	var _hoisted_4 = ["src"];
	var _hoisted_5 = { class: "yt-metadata" };
	...
	var youtubeplayer_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props) {
			...
			const lineMap = ref(new Map());
			const currentLineIndex = computed(() => {
				const pos = position.value;
				const lines = syncedLines.value;
				if (!lines.length) return -1;
				let idx = -1;
				for (let i = 0; i < lines.length; i++) if (lines[i].time <= pos) idx = i;
				else break;
				return idx;
			});
			const youtubeContainer = ref(null);
			function searchYouTube(query, relax = false) {
				return new Promise((resolve) => {
					_GM_xmlhttpRequest({
						...
						onload: (res) => {
							try {
								const entryMatches = res.responseText.match(/initialData\.push\(([\s\S]*?)\);/g);
								for (const entry of entryMatches) if (entry.includes("music_search_catalog") || entry.includes("searchEndpoint")) {
									...
									try {
										...
										for (const entry of data.contents.tabbedSearchResultsRenderer.tabs[0].tabRenderer.content.sectionListRenderer.contents) {
											...
											if (entry.itemSectionRenderer) {
												...
												const watchEndpoint = entry.itemSectionRenderer.contents[0].musicResponsiveListItemRenderer.overlay.musicItemThumbnailOverlayRenderer.content.musicPlayButtonRenderer.playNavigationEndpoint.watchEndpoint;
												const type = watchEndpoint.watchEndpointMusicSupportedConfigs.watchEndpointMusicConfig.musicVideoType;
												if (!relax && type != "MUSIC_VIDEO_TYPE_ATV") continue;
												videoID = watchEndpoint.videoId;
												break;
			...
			function onPlayerStateChange(event) {
				if (event.data === 1) {
					...
					duration.value = player.getDuration() * 1e3;
			...
			function startPositionTracking() {
				...
				positionInterval = window.setInterval(() => {
					if (player && player.getCurrentTime) position.value = player.getCurrentTime() * 1e3;
				}, 100);
			}
			...
			async function initPlayer() {
				...
				if (!videoId) {
					...
					query = `"${cleanName}" ${songArtists.value.replace(/[^A-Za-z\s]/g, "")}`;
					...
					if (!videoId && artists.length > 1) {
						...
						query = `"${cleanName}" ${artists[0].replace(/[^A-Za-z\s]/g, "")}`;
						videoId = await searchYouTube(query, true);
					}
			...
			function extractVideoID(url) {
				console.log(url);
				return new URL(url.replace(/\/+$/, "")).searchParams.get("v");
			}
			function cleanSong(name) {
				return name.replace(" ", "+").replace(/\(.*\)/, "");
			}
			async function afterPlayStart() {
				const cache = _GM_getValue(`cache:lyrics:${appleMusicID}`);
				let lrclibReq = null;
				let syncedLyrics;
				if (!cache) lrclibReq = fetch(`https://lrclib.net/api/search?q=${songName.value.replace(" ", "+")}+${artists.join("+")}`);
				else syncedLyrics = cache;
				if (lrclibReq) {
					let data = await (await lrclibReq).json();
					if (data.length == 0) {
						console.yLog("First search missed.");
						data = await (await fetch(`https://lrclib.net/api/search?q=${cleanSong(songName.value)}+${artists.join("+")}`)).json();
						if (data.length == 0) {
					...
					_GM_setValue(`cache:lyrics:${appleMusicID}`, syncedLyrics);
				}
				if (syncedLyrics == "") {
					console.yLog("No lyrics was found for this song :(");
					return;
				}
				if (syncedLyrics) syncedLyrics = syncedLyrics.split("\n") || null;
				if (!syncedLyrics) console.yLog("No song lyrics found!");
			...
			async function seek(value) {
				if (!player) return;
				player.seekTo(value / 1e3, true);
				position.value = value;
			}
			watch(isPlaying, (playing) => {
				if (playing) startPositionTracking();
			...
			function parseSyncedLyrics(lines) {
				...
				for (const line of lines) {
					...
					const time = minutes * 6e4 + seconds * 1e3 + millis;
					result.push({
						time,
						text: match[4].trim()
					});
			...
			function wrapAndInject() {
				...
				let currentRun = [];
				const runs = [];
				for (const node of nodes) if (node instanceof HTMLElement && node.tagName === "BR") {
					runs.push(currentRun);
					currentRun = [];
				} else currentRun.push(node);
				runs.push(currentRun);
				const spans = [];
				...
				for (let k = 0; k < synced.length; k++) {
					...
					for (let j = searchStart; j < searchEnd; j++) {
						...
						let matchCount = 0;
						for (const w of syncedWords) if (normDom.includes(w)) matchCount++;
						if ((syncedWords.length > 0 ? matchCount / syncedWords.length : 0) > .6) {
							if (matchedSpans.length === 0) {
								matchedSpans.push(spans[j]);
								currentSpanIdx = j;
							}
					...
					if (matchedSpans.length > 0) map.set(k, matchedSpans);
					else if (highestScore > .4 && bestSingleSpanIdx >= 0) {
			...
			watch(currentLineIndex, (newIdx) => {
				if (newIdx !== -1) highlightLine(newIdx);
				else document.querySelectorAll(".synced-line.current-line").forEach((el) => el.classList.remove("current-line"));
			});
			function highlightLine(idx) {
				...
				if (elements) elements.forEach((el) => el.classList.add("current-line"));
			}
			function init(data) {
				...
				data.detail.lyrics[0].children;
				appleMusicID = data.detail.appleMusicID;
				data.detail.artists[0];
			}
			onMounted(() => {
				window.addEventListener("lyeh:youtube:display", init, { once: true });
			});
			onBeforeUnmount(() => {
				stopPositionTracking();
				if (player) {
			...
			function editDistance(s1, s2) {
				...
				for (let i = 0; i <= s1.length; i++) {
					let lastValue = i;
					for (let j = 0; j <= s2.length; j++) if (i == 0) costs[j] = j;
					else if (j > 0) {
			...
			return (_ctx, _cache) => {
				return display.value ? (openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [
					...
					createBaseVNode("div", _hoisted_10, [
						...
						createBaseVNode("span", _hoisted_13, toDisplayString(formatTime(duration.value)), 1)
					]),
					_cache[3] || (_cache[3] = createStaticVNode("<svg class=\"logo-wrapper\" viewBox=\"30 1 65 20\" width=\"95\" height=\"60\" fill=\"currentColor\" data-v-d5e3911a><path d=\"M37.1384 18.8999V13.4399L40.6084 2.09994H38.0184L36.6984 7.24994C36.3984 8.42994 36.1284 9.65994 35.9284 10.7999H35.7684C35.6584 9.79994 35.3384 8.48994 35.0184 7.22994L33.7384 2.09994H31.1484L34.5684 13.4399V18.8999H37.1384Z\" data-v-d5e3911a></path><path d=\"M44.1003 6.29994C41.0703 6.29994 40.0303 8.04994 40.0303 11.8199V13.6099C40.0303 16.9899 40.6803 19.1099 44.0403 19.1099C47.3503 19.1099 48.0603 17.0899 48.0603 13.6099V11.8199C48.0603 8.44994 47.3803 6.29994 44.1003 6.29994ZM45.3903 14.7199C45.3903 16.3599 45.1003 17.3899 44.0503 17.3899C43.0203 17.3899 42.7303 16.3499 42.7303 14.7199V10.6799C42.7303 9.27994 42.9303 8.02994 44.0503 8.02994C45.2303 8.02994 45.3903 9.34994 45.3903 10.6799V14.7199Z\" data-v-d5e3911a></path><path d=\"M52.2713 19.0899C53.7313 19.0899 54.6413 18.4799 55.3913 17.3799H55.5013L55.6113 18.8999H57.6012V6.53994H54.9613V16.4699C54.6812 16.9599 54.0312 17.3199 53.4212 17.3199C52.6512 17.3199 52.4113 16.7099 52.4113 15.6899V6.53994H49.7812V15.8099C49.7812 17.8199 50.3613 19.0899 52.2713 19.0899Z\" data-v-d5e3911a></path><path d=\"M62.8261 18.8999V4.14994H65.8661V2.09994H57.1761V4.14994H60.2161V18.8999H62.8261Z\" data-v-d5e3911a></path><path d=\"M67.8728 19.0899C69.3328 19.0899 70.2428 18.4799 70.9928 17.3799H71.1028L71.2128 18.8999H73.2028V6.53994H70.5628V16.4699C70.2828 16.9599 69.6328 17.3199 69.0228 17.3199C68.2528 17.3199 68.0128 16.7099 68.0128 15.6899V6.53994H65.3828V15.8099C65.3828 17.8199 65.9628 19.0899 67.8728 19.0899Z\" data-v-d5e3911a></path><path d=\"M80.6744 6.26994C79.3944 6.26994 78.4744 6.82994 77.8644 7.73994H77.7344C77.8144 6.53994 77.8744 5.51994 77.8744 4.70994V1.43994H75.3244L75.3144 12.1799L75.3244 18.8999H77.5444L77.7344 17.6999H77.8044C78.3944 18.5099 79.3044 19.0199 80.5144 19.0199C82.5244 19.0199 83.3844 17.2899 83.3844 13.6099V11.6999C83.3844 8.25994 82.9944 6.26994 80.6744 6.26994ZM80.7644 13.6099C80.7644 15.9099 80.4244 17.2799 79.3544 17.2799C78.8544 17.2799 78.1644 17.0399 77.8544 16.5899V9.23994C78.1244 8.53994 78.7244 8.02994 79.3944 8.02994C80.4744 8.02994 80.7644 9.33994 80.7644 11.7299V13.6099Z\" data-v-d5e3911a></path><path d=\"M92.6517 11.4999C92.6517 8.51994 92.3517 6.30994 88.9217 6.30994C85.6917 6.30994 84.9717 8.45994 84.9717 11.6199V13.7899C84.9717 16.8699 85.6317 19.1099 88.8417 19.1099C91.3817 19.1099 92.6917 17.8399 92.5417 15.3799L90.2917 15.2599C90.2617 16.7799 89.9117 17.3999 88.9017 17.3999C87.6317 17.3999 87.5717 16.1899 87.5717 14.3899V13.5499H92.6517V11.4999ZM88.8617 7.96994C90.0817 7.96994 90.1717 9.11994 90.1717 11.0699V12.0799H87.5717V11.0699C87.5717 9.13994 87.6517 7.96994 88.8617 7.96994Z\" data-v-d5e3911a></path></svg>", 1))
				]), createBaseVNode("div", {
					ref_key: "youtubeContainer",
					ref: youtubeContainer,
					class: "youtube-player-inner"
				}, null, 512)])) : createCommentVNode("", true);
			};
		}
	}), [["__scopeId", "data-v-d5e3911a"]]);
	...
	var trackingData;
	var state = "injecting";
	function parseChangelog(md, fromVersion, toVersion) {
		const sectionRegex = /##\s+(.+)\n([\s\S]*?)(?=##\s+|\s*$)/g;
		const sections = [];
		let m;
		while ((m = sectionRegex.exec(md)) !== null) {
			const items = m[2].trim().split("\n").map((l) => l.replace(/^[-*]\s*/, "").trim()).filter(Boolean);
			sections.push({
				version: m[1],
				items
			});
		...
		const start = toIdx;
		let end;
		if (fromIdx !== -1) end = Math.min(fromIdx - 1, sections.length - 1);
		else {
			end = sections.length - 1;
			for (let i = toIdx; i < sections.length; i++) {
				const pa = sections[i].version.split(".").map(Number);
	...
	var Genie = class {
		...
		init() {
			...
			Object.defineProperty(console, "yLog", { get: () => {
				return console.realLog.bind(console, "%cLyeh%c %cYouTube", "background-color: rgba(250, 100, 160, 0.7); color: black; font-weight: bold; padding: 1px 6px; border-radius: 4px", "", "background-color: #FF5E5E; color: black; font-weight: bold; padding: 1px 6px; border-radius: 4px");
			} });
			...
			for (const category of settingsSchema) for (const setting of category.items) {
				...
				if (setting.id == "youtube") {
					if (settingValue) document.documentElement.style.setProperty(`--settings-youtube`, "none");
					else document.documentElement.style.setProperty(`--settings-youtube`, "flex");
					continue;
				}
			...
			if (lyricPageRegex.test(url.pathname)) this.mouseEvents();
		...
		observeDOM() {
			new MutationObserver(async (mutations) => {
				for (const mutation of mutations) for (const node of mutation.addedNodes) {
					...
					const bioContainer = node.matches("profile-user-pane") ? document.querySelector(`profile-user-pane > div[class^="white_container"]`) : null;
					if (bioContainer && !document.getElementById("lyeh-heatmap")) {
						...
						createApp(Heatmap_default).mount(githubSkid);
					}
					...
					if (navvar) document.documentElement.style.setProperty("--current-accent", window.getComputedStyle(navvar).backgroundColor);
					...
					if (node.querySelector(`[class^="LineItem__ItemRow"]`)) node.classList.add("lyeh__ItemParent");
					...
					if (node.matches(`[class^="ContributorList__List-sc"`)) for (const progress of node.children) {
						const Class = progress.className.split(" ")[1];
						if (!Class) continue;
						const barElem = node.getElementsByClassName(Class)[0];
						const percentageElm = barElem.querySelector(`[class^="ContributorList__AttributionValue"]`);
		...
		mountYouTube() {
			...
			window.dispatchEvent(new CustomEvent("lyeh:youtube:display", { detail: {
			...
			if (typeof YT === "undefined" || !YT.Player) {
				...
				_unsafeWindow.onYouTubeIframeAPIReady = () => {
					console.yLog("YouTube IFrame API ready.");
					window.dispatchEvent(new CustomEvent("lyeh:youtube:ready"));
				};
			} else window.dispatchEvent(new CustomEvent("lyeh:youtube:ready"));
		}
		startup() {
			state = "starting";
			this.observeDOM();
			...
			this.mountVue();
			const youtubeToggled = _GM_getValue("lyeh:settings:youtube");
			if (currentPage == "songPage" && youtubeToggled) this.mountYouTube();
			...
			if (!cacheVersion) _GM_setValue("lyeh:version", version);
				...
				const entries = parseChangelog(CHANGELOG_default, cacheVersion, version);
		...
		extractSongData() {
			trackingData = _unsafeWindow.__PRELOADED_STATE__ || null;
					...
					onload: (response) => {
						...
						tempImg.onload = async () => {
							try {
								...
								_GM_setValue(cacheKey, activeSwatch.color._oklch);
								URL.revokeObjectURL(blobUrl);
		...
		mouseEvents() {
			document.addEventListener("mouseover", async (e) => {
				...
				if (link) {
					...
					document.querySelectorAll(`a[href="${href}"] span[class^="ReferentFragment"]`).forEach((span) => span.classList.add("lyeh-linked-hover"));
				}
